...
use App\Http\Requests\Admin\BulkPriceUpdateRequest;
...
class ProductController extends BaseController
{
    ...
    public function getView(string $addedBy, string|int $id): View|RedirectResponse
    {
        ...
        return view(Product::VIEW[VIEW], compact('product', 'reviews', 'productActive', 'productColors', 'addedBy', 'isActive', 'totalSellerProducts', 'totalAdminProducts', 'productWiseTax'));
    }
