...
class OrderManager
{
    ...
    {   
        ...
        if ($order->order_type == 'pos' || $order->order_type == 'POS'){
            ...
            $delivery = getWebConfig('order_wise_shipping_cost');
        }
        ...
        return [
            ...
            'totalAmount' => ($total + $shipping + $delivery - $extraDiscount - $couponDiscount - $referAndEarnDiscount + $order['total_tax_amount']),
