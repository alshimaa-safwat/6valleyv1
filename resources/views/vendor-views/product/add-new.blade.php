                        ...
                        <div class="{{ $lang != $defaultLanguage ? 'd-none' : '' }} form-system-language-form {{ getLanguageCode($lang) }}-form"
                            ...
                            <div class="form-group pt-4">
                                ...
                                <div class="outline-wrapper" id="editor-container-{{ getLanguageCode($lang) }}">
                                    <textarea name="description[]" id="description-{{ getLanguageCode($lang) }}" class="summernote {{ $lang == $defaultLanguage ? 'product-description-default-language' : '' }}">{{ old('details') }}</textarea>
                                </div>
                            </div>
                        </div>
                    @endforeach
