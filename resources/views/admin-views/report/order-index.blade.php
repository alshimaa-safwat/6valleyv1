                    ...
                    <div class="row g-3 align-items-end">
                        <div class="col-sm-6 col-md-3">
                            ...
                            <select class="custom-select text-ellipsis" name="seller_id">
                                <option value="all" {{ $seller_id == 'all' ? 'selected' : '' }}>{{ translate('all') }}
                                </option>
                        ...
                        <div class="col-sm-6 col-md-3">
                            <label class="mb-2">{{ translate('order_type') }}</label>
                            <select class="custom-select text-ellipsis" name="order_type">
                                <option value="all" {{ $order_type == 'all' ? 'selected' : '' }}>{{ translate('all') }}
                                </option>
                                <option value="default_type" {{ $order_type == 'default_type' ? 'selected' : '' }}>
                                    {{ translate('default_Type') }}</option>
                                <option value="POS" {{ $order_type == 'POS' ? 'selected' : '' }}>{{ translate('POS') }}
                                </option>
                            </select>
                        </div>
                        ...
                        <div class="col-sm-6 col-md-3">
                            ...
                            <select class="custom-select text-ellipsis" name="brand_id">
                                <option value="all"
                                    {{ request('brand_id') == 'all' || !request('brand_id') ? 'selected' : '' }}>
                                    {{ translate('all') }}</option>
                                <option value="no_brand" {{ request('brand_id') == 'no_brand' ? 'selected' : '' }}>
                                    {{ translate('no_Brand') }}</option>
            ...
            <div class="d-flex flex-column gap-3 flex-grow-1">
                <div class="card card-body">
                    <div class="d-flex gap-3 align-items-center mb-4">
                        <img width="35" src="{{ dynamicAsset(path: 'public/assets/back-end/img/cart.svg') }}"
                            alt="{{ translate('image') }}">
                        <div class="info">
                    ...
                    <div class="coupon__discount d-flex flex-wrap justify-content-around gap-2">
                        <div class="text-center">
                            ...
                            <div class="d-flex gap-2 align-items-center fs-12">
                                ...
                                <span class="lh-1" data-bs-toggle="tooltip"
                                    data-bs-title="{{ translate('this_count_is_the_summation_of') }} {{ translate('failed_to_deliver') }}, {{ translate('canceled') }}, {{ translate('and') }} {{ translate('returned_orders') }}">
                        ...
                        <div class="text-center">
                            ...
                            <div class="d-flex gap-2 align-items-center fs-12">
                                ...
                                <span class="lh-1" data-bs-toggle="tooltip"
                                    data-bs-title="{{ translate('this_count_is_the_summation_of') }} {{ translate('pending') }}, {{ translate('confirmed') }}, {{ translate('packaging') }}, {{ translate('out_for_delivery_orders') }}">
                                    <i class="fi fi-rr-info"></i>
                                </span>
                            </div>
                        </div>
                        <div class="text-center">
                            ...
                            <div class="d-flex gap-2 align-items-center fs-12">
                                ...
                                <span class="lh-1" data-bs-toggle="tooltip"
                                    data-bs-title="{{ translate('this_count_is_the_summation_of_delivered_orders') }}">
                                    <i class="fi fi-rr-info"></i>
                                </span>
                            </div>
                        </div>
                ...
                <div class="card card-body">
                    <div class="d-flex gap-3 align-items-center mb-4">
                        <img width="35" src="{{ dynamicAsset(path: 'public/assets/back-end/img/products.svg') }}"
                            alt="{{ translate('image') }}">
                        <div class="info">
                    ...
                    <div class="coupon__discount d-flex gap-2 justify-content-around">
                        <div class="text-center">
                            ...
                            <div class="d-flex gap-2 align-items-center fs-12">
                                ...
                                <span class="trx-y-2 ml-2" data-bs-toggle="tooltip"
                                    data-bs-title="{{ translate('the_ongoing_order_amount_will_be_shown_here') }}">
                                    <i class="fi fi-rr-info"></i>
                                </span>
                            </div>
                        </div>
                        <div class="text-center">
                            ...
                            <div class="d-flex gap-2 align-items-center fs-12">
                                ...
                                <span class="trx-y-2 ml-2" data-bs-toggle="tooltip"
                                    data-bs-title="{{ translate('after_the_order_is_delivered_total_order_amount_will_be_shown_here') }}">
                                    <i class="fi fi-rr-info"></i>
                                </span>
                            </div>
                        </div>
                        ...
                        <form action="" method="GET" class="mb-0">
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="hidden" value="{{ request('brand_id') ?? 'all' }}" name="brand_id">
                                    <input id="datatableSearch_" value="{{ $search }}" name="search"
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                <li>
                                    <a class="dropdown-item d-flex align-items-center gap-2"
                                        href="{{ route('admin.report.order-report-excel', ['date_type' => request('date_type'), 'seller_id' => request('seller_id'), 'from' => request('from'), 'to' => request('to'), 'search' => request('search'), 'order_type' => request('order_type'), 'brand_id' => request('brand_id')]) }}">
                                ...
                                <li>
                                    <a class="dropdown-item d-flex align-items-center gap-2"
                                        href="{{ route('admin.report.order-report-pdf', ['date_type' => request('date_type'), 'seller_id' => request('seller_id'), 'from' => request('from'), 'to' => request('to'), 'search' => request('search'), 'order_type' => request('order_type'), 'brand_id' => request('brand_id')]) }}">
                                        <span class="text-warning pt-1"><i class="fi fi-sr-file-pdf"></i></span>
                    ...
                    <table id="datatable"
                        ...
                        <thead class="thead-light thead-50 text-capitalize">
                            <tr>
                                ...
                                <th>{{ translate('shipping_Method') }}</th>
                        ...
                        <tbody>
                            @foreach ($orders as $key => $order)
                                <tr>
                                    ...
                                    <td>{{ setCurrencySymbol(amount: usdToDefaultCurrency(amount: $order?->refer_and_earn_discount ?? 0), currencyCode: getCurrencyCode()) }}
                                    </td>
