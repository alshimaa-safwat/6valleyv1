                    ...
                    <div class="row g-3 align-items-end">
                        ...
                        <div class="col-sm-6 col-md-3">
                            ...
                            <select class="custom-select text-ellipsis" name="order_type">
                                <option value="all" {{ $order_type == 'all' ? 'selected' : '' }}>{{ translate('all') }}</option>
                                <option value="default_type" {{ $order_type == 'default_type' ? 'selected' : '' }}>{{ translate('default_Type') }}</option>
                                <option value="POS" {{ $order_type == 'POS' ? 'selected' : '' }}>{{ translate('POS') }}</option>
                            </select>
                        </div>
