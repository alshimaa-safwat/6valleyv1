...
@section('content')
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-8 mt-3 mt-lg-0 d-flex flex-wrap gap-3 justify-content-lg-end">
                                ...
                                @if ($type == 'in_house')
                                    ...
                                    <button type="button" class="btn btn-primary" data-bs-toggle="offcanvas" data-bs-target="#bulkPriceAdjustmentOffcanvas">
                                        <i class="fi fi-sr-price-tag"></i>
                                        <span class="text">{{ translate('Bulk_Price_Adjustment') }}</span>
                                    </button>
                                @endif
                            </div>
                        </div>
    ...
    @include('admin-views.product.offcanvas._bulk-price-adjustment-offcanvas')
@endsection
