                        ...
                        <div class="px-sm-5 overflow-x-auto">
                            <table class="table table-borderless table-sm mb-0 text-sm-right text-nowrap">
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="text-end text-body"><strong>{{ translate('delivery') }}</strong></td>
                                        <td class="text-end text-dark">
                                            <strong>{{ setCurrencySymbol(amount: usdToDefaultCurrency(amount: getWebConfig('order_wise_shipping_cost')), currencyCode: getCurrencyCode()) }}</strong>
                                        </td>
                                    </tr>
