<aside class="col-lg-4 pt-4 pt-lg-2 px-max-md-0 order-summery-aside">
    <div class="__cart-total __cart-total_sticky">
        <div class="cart_total p-0">
            ...
            @php($delivery = getWebConfig('order_wise_shipping_cost'))
            ...
            <div class="d-flex justify-content-between">
             ...
             <div class="d-flex justify-content-between">
                <span class="cart_title">{{ translate('delivery') }}</span>
                <span class="cart_value">
                    {{ webCurrencyConverter(amount: $delivery) }}
                </span>
            </div>
            <div class="d-flex justify-content-between">
            ...
            <?php
                ...
                $totalAmount = $subTotal + $delivery + ($totalTax['item_tax'] + $totalTax['shipping_cost_tax']) + $totalShippingCost - $coupon_dis - $totalDiscountOnProduct;
